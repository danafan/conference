		...
		<el-card class="tab_card" shadow="never">
			<el-form :inline="true" size="mini">
				<el-form-item label="会议类型：">
					<el-select v-model="type" placeholder="请选择会议类型" @change="meetingRecord">
						<el-option v-for="item in type_list" :key="item.id" :label="item.name" :value="item.id">
						</el-option>
					</el-select>
				</el-form-item>
				<el-form-item label="日期:">
					<el-date-picker v-model="date" type="daterange" unlink-panels value-format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" @change="meetingRecord">
					</el-date-picker>
				</el-form-item>
				<el-form-item label="部门：">
					<el-select v-model="dept_id" clearable multiple filterable collapse-tags placeholder="请选择部门" @change="meetingRecord">
				...
				<el-form-item label="搜索会议：">
					<el-input v-model="search" clearable placeholder="搜索会议主题" @change="meetingRecord"></el-input>
				</el-form-item>
				<el-form-item label="级别：">
					<el-checkbox-group v-model="meeting_level" @change="meetingRecord">
